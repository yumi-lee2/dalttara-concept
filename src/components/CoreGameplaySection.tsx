...
const aspects = [
  {
    emoji: "💬",
    title: "대화",
    desc: "플레이어가 건네는 한마디, 질문 하나가 오늘의 달생이를 만듭니다. 대화는 감정과 선택의 짧은 로그로 축적됩니다.",
  },
  {
    emoji: "🌱",
    title: "성향 형성",
    desc: "축적된 대화는 달생이의 성향을 조금씩 바꾸어 갑니다. 어떤 말을 더 자주 듣느냐에 따라 서로 다른 가치관이 형성됩니다.",
  },
  {
    emoji: "✨",
    title: "이벤트와 성장",
    desc: "형성된 성향에 따라 만나는 사건과 선택지가 달라집니다. 그 속에서 달생이는 직업과 지구로 가는 길을 찾아 나갑니다.",
  },
];
